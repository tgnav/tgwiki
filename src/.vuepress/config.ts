...
export default defineUserConfig({
  ...
  head: [
    ...
    ['script', {}, `start_param
let startParam = window.Telegram.WebApp.initDataUnsafe.start_param; let domain = window.location.hostname; if (!startParam) { window.location.href = domain + '/tgwiki'; } else { console.log(startParam); window.location.href = domain
+ '/tgwiki/' +startParam;
}`],
  ],
  theme,
